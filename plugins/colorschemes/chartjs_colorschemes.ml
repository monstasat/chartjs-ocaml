...
module Scheme = struct
  ...
  let tableau_ClassicRedWhiteBlackLight10 = Js.string "tableau.ClassicRedWhiteBlackLight10"
  let tableau_ClassicOrangeWhiteBlueLight11 = Js.string "tableau.ClassicOrangeWhiteBlueLight11"
  let tableau_ClassicRedWhiteGreenLight11 = Js.string "tableau.ClassicRedWhiteGreenLight11"
  let tableau_ClassicRedGreenLight11 = Js.string "tableau.ClassicRedGreenLight11"

  let make = Js.string
end

class type colorschemes = object
  ...
  method custom :
    (Js.js_string Js.t Js.js_array Js.t
     -> Js.js_string Js.t Js.js_array Js.t)
      Js.callback Js.optdef Js.prop
end

let create () = Js.Unsafe.obj [||]

let of_chart chart =
  (Js.Unsafe.coerce chart)##.options##.plugins##.colorschemes

let of_global () =
  Js.Unsafe.global##._Chart##.defaults##.global##.plugins##.colorschemes

let set_per_chart chart plugin =
  (Js.Unsafe.coerce chart)##.options##.plugins##.colorschemes := plugin
