...
(function(joo_global_object)
   {"use strict";
    ...
    var index="index",typ="bar",chart_constr=window.Chart,dataset1={};
    dataset1.data = caml_js_from_array(_e_.slice());
    ...
    var a=_f_.slice(),f=caml_js_from_string,l=a.length - 1;
    if(0 === l)
     var labels=[0];
    else
    ...
    var
     ...
     chart=new chart_constr("bar",config);
    window.chart = chart;
    function iter(param)
     {var param$0=param;
      for(;;)
